 ...
 * Generated for Laravel 5.7.12 on 2019-04-24 08:38:56.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Storage {
        ...
        /**
         * Create an instance of the Amazon S3Service driver.
         *
         * @param array $config
...
namespace hamburgscleanest\LaravelGuzzleThrottle\Facades {
    ...
    class LaravelGuzzleThrottle {
         ...
         *
         * @param array $config
         * @return \hamburgscleanest\LaravelGuzzleThrottle\Models\Client
         * @throws \Exception
         * @static
         */
        public static function client($config)
        {
            return \hamburgscleanest\LaravelGuzzleThrottle\Models\GuzzleThrottle::client($config);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {
            ...
            {
                return \Illuminate\Database\Query\Builder::insertIgnore($values);
            }
             ...
             * @static
             */
            public static function insertOnDuplicateKey($values, $columnsToUpdate = null, $type = 'on duplicate key')
            {
                return \Illuminate\Database\Query\Builder::insertOnDuplicateKey($values, $columnsToUpdate, $type);
            }
    ...
    class GuzzleThrottle extends \hamburgscleanest\LaravelGuzzleThrottle\Facades\LaravelGuzzleThrottle {}
